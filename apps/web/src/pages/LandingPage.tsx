                ...
                <div className="flex items-center flex-col md:flex-row justify-center px-2 gap-2 transition-all duration-300">
                    ...
                    <div className="flex flex-col w-md sm:w-xl md:w-5xl">
                        ...
                        <div className="flex items-center pr-48  py-4 gap-4">
                            ...
                            {/*Play button*/}
                            <button className="text-xs bg-white text-text-primary  flex justify-center items-center gap-1 font-semibold rounded-md w-32 h-8 py-2 px-2 hover:opacity-90 transition-colors duration-300 cursor-pointer">
