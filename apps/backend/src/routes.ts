...
import { getMySessions, getMyActivity, createSession, getSessionByCode, getJoinSessionPreview, submitSessionCode, getAnalytics } from "./modules/sessions/sessions.controller.js";
...
router.get("/api/analytics", requireAuth, getAnalytics);
